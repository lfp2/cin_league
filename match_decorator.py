...
API_KEY = 'RGAPI-8aeaca9b-6e1a-4bbc-b64b-99215ab11533'
...
def req(game_id, key):
  ...
  url = 'https://br1.api.riotgames.com/lol/match/v4/timelines/by-match/%s?api_key=%s' %(game_id, key)
...
for id in ids:
  ...
  if match:
    with open(path, 'w') as f: f.write(str(match))
  i += 1
''
# TEST ID: '1649289144'